...
//  CalculadoraUIkit
//
//  Created by Marcelo de Araújo on 04/09/2022
//
import SwiftUI
...
public extension DateFormatter {
    static func defaultFormat() -> DateFormatter {
        ...
        dateFormatterGet.locale = Locale(identifier: NSLocale.current.languageCode ?? "pt_BR")
...
extension String {
    ...
    func spellOut() -> String {
        ...
        var newString = numberAsWord.replacingOccurrences(of: "Mil", with: "Mil,").replacingOccurrences(of: "Bilhão", with: "Bilhão,").replacingOccurrences(of: "Milhão", with: "Milhão,").replacingOccurrences(of: "vírgula", with: "vírgula,")
